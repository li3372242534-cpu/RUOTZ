...
add_body(doc,
    ...
    "事件频发，科技界的诚信危机已不容忽视。Retraction Watch 数据库显示，全球"
    "撤稿数量逐年攀升，相当比例源于人为造假。这一现象的深层根源，在于科研人员"
    "在个人名利前途与道德养生之间发生了严重失衡。")
add_body(doc,
    "自然辩证法作为科学技术的哲学反思，不仅关注科技发展的客观规律，更关注科研"
    "主体的精神世界与价值取向[5]。重读老子\u201c善摄生者\u201d与孔子\u201c仁"
    "者寿\u201d的养生思想，结合当代自然辩证法的自然观、科技观与科技方法论，对"
    "于反思科研人员的道德自觉、提升其生活品质，具有深刻的现实意义。")

# 二
add_heading(doc, "二、老孔养生思想的核心要义")
add_body(doc,
    "道家养生思想以淡泊为本。老子《道德经》第五十章云：\u201c盖闻善摄生者，"
    "陆行不遇兕虎，入军不被甲兵\u201d[1]，奠定了道家\u201c摄生\u201d观的基"
    "调。后世道教承此思路，由唐代孙思邈托名所撰、收入《云笈七签》的《摄养枕"
    "中方》进一步提出\u201c六害\u201d之说：\u201c且夫善摄生者，要当先除六"
    "害，然后可以保性命，延驻百年\u201d；所谓六害，即\u201c一者薄名利，二者"
    "禁声色，三者廉货财，四者损滋味，五者除佞妄，六者去妒忌\u201d[2]。其中"
    "\u201c薄名利\u201d列居首位，足见名利之累乃养生之最大障碍。若名利不除，"
    "纵然\u201c心希妙理，口念真经\u201d，亦\u201c不能补其短促\u201d。这一思"
    "想揭示了朴素真理：养生之本在于养心，养心之要在于淡泊。")
add_body(doc,
    "孔子的养生观则与\u201c仁\u201d紧密相连。《论语·雍也》曰：\u201c知者乐"
    "水，仁者乐山；知者动，仁者静；知者乐，仁者寿。\u201d[3] 仁者之所以寿，"
    "在于其内心宽厚平和，能够\u201c恭、宽、信、敏、惠\u201d五德兼备。《论语·"
    "述而》第十六章记孔子自况：\u201c饭疏食饮水，曲肱而枕之，乐亦在其中矣\u201d；"
    "同篇第十九章又云：\u201c发愤忘食，乐以忘忧，不知老之将至云尔\u201d[3]。"
    "这种安贫乐道、专注于学的精神状态，恰是当代部分科研人员所缺失的境界。")
add_body(doc,
    "老孔养生思想虽分属道、儒两家，却殊途同归地指向同一核心命题：真正的健康"
    "长寿不在物质的丰盈，而在德性的涵养。过度追求外在奉养，往往\u201c损于其"
    "本而妄求其末\u201d；唯有养心、养德，方能延年益寿。")
...
add_body(doc,
    ...
    "[4] 这一警示与老子\u201c道法自然\u201d的思想遥相呼应。科研人员作为认识"
...
add_body(doc,
    ...
    "科技的善恶不取决于技术本身，而取决于使用技术的人[8]。爱因斯坦曾言："
    "\u201c关心人本身和人的命运，必须始终成为一切技术努力的主要目标。\u201d[6] "
...
add_body(doc,
    ...
    "敏于事而慎于言。\u201d[3] 这正是科研方法论的古典表达——在治学态度上敏锐"
...
add_body(doc,
    "老子\u201c薄名利\u201d的智慧，对当代科研人员具有直接警醒意义。所谓"
    "\u201c薄\u201d，并非否定名利的存在，而是不为名利所累。诸葛亮\u201c非淡泊"
    "无以明志，非宁静无以致远\u201d，与老子之意一脉相承。科研人员当将名利视作"
    "研究的副产品，而非追求的目标。屠呦呦数十年潜心于青蒿素研究，钟扬十六载守"
    "望雪域采集种子，他们的事迹证明：唯有薄名利，才能成大器。")

add_subheading(doc, "（二）去妒忌：构建合作共赢的科研生态")
add_body(doc,
    "老子\u201c六害\u201d中的\u201c除佞妄\u201d\u201c去妒忌\u201d，揭示了"
    "科研团队内部的伦理要求。学术不端的另一土壤是同行之间的恶性竞争与相互倾"
    "倾轧。剽窃成果、阻挠同行发表、滥用评议权力等行为，皆源于妒忌之心"
    "[7]。孔子\u201c宽则得众\u201d\u201c信则人任焉\u201d的教诲，启示我们以"
    "宽厚之心对待同行，以信任之态合作创新，方能形成良性学术共同体。")

add_subheading(doc, "（三）仁者寿：以德性涵养支撑科研生涯")
add_body(doc,
    "科研是一项长跑而非短跑。许多科研人员英年早逝、心力交瘁，固然有工作强度"
    "因素，但更深层的原因在于心态失衡。孔子\u201c仁者乐山，仁者静，仁者"
    "寿\u201d的洞见，揭示了道德境界与身心健康的内在统一[3]。心怀仁爱、安于求"
    "道的科研人员，更能在漫长学术道路上保持身心平衡，实现可持续创造。可见，"
    "养德即养生，立德即立命。")

add_subheading(doc, "（四）制度与自觉：他律与自律的双重保障")
add_body(doc,
    "当然，仅靠道德自觉不足以根除学术不端，还需建立健全的科研诚信制度。一是"
    "完善学术评价体系，破除\u201c唯论文\u201d\u201c唯帽子\u201d的导向；二是"
    "强化学术伦理教育，将自然辩证法的科技伦理纳入研究生必修课程；三是建立学"
    "术不端的严厉惩戒机制，使违规者付出代价。制度是底线，自觉是高线，二者结"
    "合方能形成清朗的科研环境[8]。")

# 五
add_heading(doc, "五、结语")
add_body(doc,
    "老子曰：\u201c五色令人目盲，五音令人耳聋，五味令人口爽。\u201d[1] 过度名"
    "利追逐，损害的是科研人员的道德生命与学术生命。孔子\u201c发愤忘食，乐以"
    "忘忧，不知老之将至\u201d的境界，则展示了以学问为乐、以道德为本的理想人"
    "格。在自然辩证法的视域下，科技进步与个人修养从来不是对立的两极，而是辩"
    "证统一的整体。科研人员唯有\u201c薄名利\u201d以养其德，\u201c敏于事\u201d"
    "以求其真，\u201c乐山水\u201d以养其心，方能在个人前途与道德养生之间实现"
    "真正的平衡。这不仅是个人生活品质的提升，更是科技事业行稳致远的根本保障。"
    "当每一位科研人员都能以淡泊之心做学问、以仁厚之心待同行、以敬畏之心对自"
    "然，中国科技强国之梦才能真正照进现实。")

# 参考文献
add_heading(doc, "参考文献")
add_ref(doc, "[1] 老子. 道德经[M]. 陈鼓应, 注译. 北京: 中华书局, 2009.")
add_ref(doc, "[2] 张君房. 云笈七签[M]. 蒋力生, 等校注. 北京: 华夏出版社, 1996.")
add_ref(doc, "[3] 杨伯峻. 论语译注[M]. 北京: 中华书局, 2017.")
add_ref(doc, "[4] 恩格斯. 自然辩证法[M]. 中共中央马克思恩格斯列宁斯大林著作编译局, 译. 北京: 人民出版社, 2018.")
add_ref(doc, "[5] 郭贵春. 自然辩证法概论[M]. 北京: 高等教育出版社, 2019.")
add_ref(doc, "[6] 爱因斯坦. 爱因斯坦文集: 第三卷[M]. 许良英, 等编译. 北京: 商务印书馆, 2010.")
add_ref(doc, "[7] 科技部, 中央宣传部, 最高人民法院, 等. 关于进一步加强科研诚信建设的若干意见[Z]. 国科发政〔2018〕198号. 2018-05-30.")
add_ref(doc, "[8] 王前. 中国科技伦理史纲[M]. 北京: 人民出版社, 2006.")
